//
//  ListGroceryCollectionView.swift
//  Listko
//
...
extension ListGroceryViewController: UITableViewDataSource, UITableViewDelegate, SwipeTableViewCellDelegate {
  ...
  func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    self.performSegue(withIdentifier: "ShowGrocery", sender: self)
  }
