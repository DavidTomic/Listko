...
extension EditItemViewController: UITableViewDataSource, UITableViewDelegate, EditCellProtocol {
  ...
  func addTableViewFooter(height: CGFloat) {
    print("addTableViewFooter \(height)")
